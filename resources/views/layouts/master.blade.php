               ...
               <ul class="navbar-nav nav-center site-logo">
                   <li>
                       <a href="">
                           ...
                           <span class="brand-text">Perdosri</span>
                       </a>
                   </li>
               </ul>
           ...
           <nav class="top-toolbar navbar navbar-desktop flex-nowrap">
               <ul class="navbar-nav nav-left">
                   <li class="nav-item nav-text">
                       <a href="{{ url('/') }}">
                           <i class="la la-home"></i> Halaman Utama
                       </a>
                   </li>
               </ul>
               <ul class="navbar-nav nav-right">
                       ...
                       <div class="dropdown-menu dropdown-menu-right dropdown-menu-account">
                           <div class="dropdown-header pb-3">
                               <div class="media d-user">
                                   <img class="align-self-center mr-3 w-40 h-40 rounded-circle"
                                       src="{{ asset('backend/assets/img/user.png') }}" alt=""
                           ...
                           <a class="dropdown-item" href="">
                               <i class="la la-user"></i> Ubah Profil
                           </a>
                           <a class="dropdown-item" href="">
                               <i class="zmdi zmdi-lock-open zmdi-hc-fw"></i> Ubah Password
                           </a>
